...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.i_am_the_elder_god = factory();
    }
}( this, function() {
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "i_am_the_elder_god.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "i_am_the_elder_god.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'i_am_the_elder_god'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'i_am_the_elder_god':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_4a73f50886792b947b390d3103b773f470f4ddb8": function($0, $1) {
            ...
            "__cargo_web_snippet_68de7147421314d2468767264f80d7b2d0d2de4f": function($0, $1) {
            ...
            "__cargo_web_snippet_8e962239a81929064544ff3aadf9466c248af5ac": function($0, $1) {
            ...
            "__cargo_web_snippet_9e5c7b354a45c655091966d4b37449d00f4cadf7": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0).responseType="arraybuffer";
            },
            ...
            "__cargo_web_snippet_f858ab98b72664ae818f9057e58c16bcf1efbbe5": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0).cloneNode().play();
            },
